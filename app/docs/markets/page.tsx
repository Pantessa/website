    ...
    <>
      ...
      <div className="docs__prose">
        ...
        <p>
          ...
          list fills itself with what the wallet holds — ETH, your Robinhood Chain stocks, the coins we chart — and each of
          those rows shows your position beside its price, in dollars and in tokens. A holding you remove stays off
          until you add it back. A guest&rsquo;s list lives
