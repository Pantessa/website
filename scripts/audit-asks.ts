...
const CORPUS: Entry[] = [
  ...
  { ask: '2x Long $25 of ETH on Hyperliquid', source: 'MK2/EXEC QuickAct index-row chip', expect: 'action' },
  { ask: '2x Short $25 of SOL on Hyperliquid', source: 'MK2/EXEC QuickAct index-row chip (non-EVM home)', expect: 'action' },
  { ask: 'Buy $25 of ETH on Ethereum', source: 'MK2/EXEC QuickAct index-row chip', expect: 'action' },
]
