...
export { default } from '@/components/markets/viz/MarketMap'
import type Real from '@/components/markets/viz/MarketMap'
export type MarketMapProps = Parameters<typeof Real>[0]
