...
export { default } from '@/components/markets/ai/AskChart'
import type Real from '@/components/markets/ai/AskChart'
export type AskChartProps = Parameters<typeof Real>[0]
