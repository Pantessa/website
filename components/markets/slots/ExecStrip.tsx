...
export { default } from '@/components/markets/trade/ExecStrip'
import type Real from '@/components/markets/trade/ExecStrip'
export type ExecStripProps = Parameters<typeof Real>[0]
