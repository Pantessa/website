...
export { default } from '@/components/markets/viz/MoversTape'
import type Real from '@/components/markets/viz/MoversTape'
export type MoversTapeProps = Parameters<typeof Real>[0]
