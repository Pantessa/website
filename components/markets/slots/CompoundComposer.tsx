...
export { default } from '@/components/markets/trade/CompoundComposer'
import type Real from '@/components/markets/trade/CompoundComposer'
export type CompoundComposerProps = Parameters<typeof Real>[0]
