...
//
// This file lives in components/ on purpose: Tailwind's content globs scan
// pages/, components/ and app/ — NOT lib/ — so a class that appears only in a
// lib/ string is never generated (the phone rules here measured 58px tall
// and unrounded until the string moved; lib/sign-cta re-exports it).
