// @canonical lib/hl-guardian.ts — full copy; scripts/guard-sync-check.ts enforces byte-parity (modulo import lines + this header).
// ─────────────────────────────────────────────────────────────────────────
...
import { buildReport, type GuardrailCheck, type GuardrailReport } from './tx-guardrails'
